        ...
        <div class="w-full d-flex align-items-center justify-content-between px-4 md:px-10">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu flex items-center space-x-6">
                    ...
                    <li class="menu-has-children"><a href="#program-kerja">Event</a>
                        <ul>
                    ...
                    <li class="menu-has-children"><a href="#informasi-terkait">Penerimaan Mahasiswa</a>
                        <ul>
                            <li><a href="{{route('login')}}">PKKMB FT</a></li>
                        </ul>
                    </li>
        ...
        <section id="about">
            ...
            <div class="flex flex-col md:flex-row items-center justify-center py-20 px-6 md:px-10">
                ...
                <div class="about-text w:full md:w-1/2">
                    ...
                    <h2 class="text-gray-800 font-bold text-3xl sm:text-4xl uppercase">Senat Mahasiswa Fakultas Teknik</h2>
            ...
            <div class="flex flex-col-reverse md:flex-row  items-center justify-center pb-20 px-6 md:px-10">
                <div class="about-text w-full md:w-1/2">
                    ...
                    <h2 class="text-gray-800 font-bold text-3xl sm:text-4xl uppercase">Badan Perwakilan Mahasiswa Fakultas Teknik</h2>
                    <p class="text-gray-600 mt-2 mb-1">
        ...
        <section id="prodi" class="py-20 px-6 md:px-10 bg-neutral-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 content-start mt-5">
                <div class="bg-white flex flex-col items-center space-y-2 border border-gray-300 p-4 rounded-md hover:shadow-lg transition-all duration-500">
                    <img src="{{ url('img/logo-prodi/hma.png') }}" class="w-24" alt="Logo Arsitektur">
                ...
                <div class="bg-white flex flex-col items-center space-y-2 border border-gray-300 p-4 rounded-md hover:shadow-lg transition-all duration-500">
                    <img src="{{ url('img/logo-prodi/hms.png') }}" class="w-24" alt="Logo Teknik Sipil">
                ...
                <div class="bg-white flex flex-col items-center space-y-2 border border-gray-300 p-4 rounded-md hover:shadow-lg transition-all duration-500">
                    <img src="{{ url('img/logo-prodi/hmm.png') }}" class="w-24" alt="Logo Teknik Mesin">
                ...
                <div class="bg-white flex flex-col items-center space-y-2 border border-gray-300 p-4 rounded-md hover:shadow-lg transition-all duration-500">
                    <img src="{{ url('img/logo-prodi/hme.png') }}" class="w-24" alt="Logo Teknik Elektro">
                ...
                <div class="bg-white flex flex-col items-center space-y-2 border border-gray-300 p-4 rounded-md hover:shadow-lg transition-all duration-500">
                    <img src="{{ url('img/logo-prodi/hmtin.png') }}" class="w-24" alt="Logo Teknik Industri">
                ...
                <div class="md:col-span-2 lg:col-span-1 lg:col-start-2 bg-white flex flex-col items-center space-y-2 border border-gray-300 p-4 rounded-md hover:shadow-lg transition-all duration-500">
                    <img src="{{ url('img/logo-prodi/hmtl.png') }}" class="w-24" alt="Logo Teknik Lingkungan">
        ...
        <section id="kelompok-studi" class="py-20 px-6 md:px-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 place-content-center mt-5">
                <div class="flex flex-col items-center space-y-2 p-4 group">
                    <img src="{{ url('img/logo-kelompok-studi/maestro.png') }}" class="w-24 opacity-70 group-hover:opacity-100 transition-all duration-300" alt="">
                ...
                <div class="flex flex-col items-center space-y-2 p-4 group">
                    <img src="{{ url('img/logo-kelompok-studi/tecart.png') }}" class="w-24 opacity-70 group-hover:opacity-100 transition-all duration-300" alt="">
                ...
                <div class="flex flex-col items-center space-y-2 p-4 group">
                    <img src="{{ url('img/logo-kelompok-studi/ureka.png') }}" class="w-24 opacity-70 group-hover:opacity-100 transition-all duration-300" alt="">
                ...
                <div class="flex flex-col items-center space-y-2 p-4 group">
                    <img src="{{ url('img/logo-kelompok-studi/robot.png') }}" class="w-24 opacity-70 group-hover:opacity-100 transition-all duration-300" alt="">
                ...
                <div class="flex flex-col items-center space-y-2 p-4 group">
                    <img src="{{ url('img/logo-kelompok-studi/cipta-loka.png') }}" class="w-24 opacity-70 group-hover:opacity-100 transition-all duration-300" alt="">
                ...
                <div class="flex flex-col items-center space-y-2 p-4 group">
                    <img src="{{ url('img/logo-kelompok-studi/etc.png') }}" class="w-24 opacity-70 group-hover:opacity-100 transition-all duration-300" alt="">
                ...
                <div class="flex flex-col items-center space-y-2 p-4 group">
                    <img src="{{ url('img/logo-kelompok-studi/parasugeni.png') }}" class="w-24 opacity-70 group-hover:opacity-100 transition-all duration-300" alt="">
                ...
                <div class="flex flex-col items-center space-y-2 p-4 group">
                    <img src="{{ url('img/logo-kelompok-studi/paksi.png') }}" class="w-24 opacity-70 group-hover:opacity-100 transition-all duration-300" alt="">
                ...
                <div class="flex flex-col items-center space-y-2 p-4 group">
                    <img src="{{ url('img/logo-kelompok-studi/ieee.png') }}" class="w-24 opacity-70 group-hover:opacity-100 transition-all duration-300 py-4" alt="">
